<div>
    ...
    <nav style="position:fixed; top:0; left:0; right:0; z-index:50; background:rgba(245,237,224,0.92); backdrop-filter:blur(12px); border-bottom:1px solid #E0D5C5;">
        <div style="max-width:1200px; margin:0 auto; padding:0.75rem 1.5rem; display:flex; align-items:center; justify-content:space-between;">
            ...
            <div style="display:flex; align-items:center; gap:1.5rem;">
                <a href="#about" style="text-decoration:none; color:#6B6158; font-weight:600; font-size:0.85rem; display:none;" class="md-show">Câu chuyện</a>
                <a href="#courses" style="text-decoration:none; color:#6B6158; font-weight:600; font-size:0.85rem; display:none;" class="md-show">Khóa học</a>
                <a href="#community" style="text-decoration:none; color:#6B6158; font-weight:600; font-size:0.85rem; display:none;" class="md-show">Cộng đồng</a>
                <a href="#press" style="text-decoration:none; color:#6B6158; font-weight:600; font-size:0.85rem; display:none;" class="md-show">Báo chí</a>
                @auth
    ...
    <section style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:6rem 1.5rem 4rem; position:relative; overflow:hidden;">
        ...
        <div style="max-width:800px; text-align:center;">
            <p class="fade-in" style="font-size:1.05rem; font-weight:700; color:#D4896E; letter-spacing:0.06em; text-transform:uppercase; margin-bottom:1.25rem;">
                Cuc Cu's Dream Factory
            </p>
            <h1 class="fade-in-up delay-1" style="font-size:clamp(2.2rem,5.5vw,3.8rem); font-weight:900; line-height:1.15; color:#2D2926; margin-bottom:1.5rem;">
                Đánh thức <span style="color:#D4896E;">giấc mơ</span> nguyên thuỷ<br>
                qua <span style="color:#7B8B6F;">nghệ thuật</span>
            </h1>
            <p class="fade-in-up delay-2" style="font-size:1.2rem; color:#5A524C; line-height:1.8; max-width:580px; margin:0 auto 2.5rem; font-weight:500;">
            ...
            <div class="fade-in-up delay-3" style="display:flex; gap:1rem; justify-content:center; flex-wrap:wrap;">
                <a href="{{ route('register') }}" class="btn" style="background:#D4896E; color:#fff; padding:0.85rem 2.25rem; border-radius:9999px; font-size:1.05rem; font-weight:800; text-decoration:none; box-shadow:0 4px 15px rgba(212,137,110,0.3);">
                    Bắt đầu hành trình
                </a>
                <a href="#about" class="btn" style="background:#FFFCF7; color:#2D2926; padding:0.85rem 2.25rem; border-radius:9999px; font-size:1.05rem; font-weight:700; text-decoration:none; border:1.5px solid #C8B9A5;">
                    Khám phá thêm
                </a>
            </div>

            {{-- Stats --}}
            <div class="fade-in-up delay-4" style="display:flex; gap:3rem; justify-content:center; margin-top:3.5rem; flex-wrap:wrap;">
                <div style="text-align:center;">
                    <div style="font-size:2rem; font-weight:900; color:#D4896E;">15,000+</div>
                    <div style="font-size:0.85rem; color:#5A524C; font-weight:700;">Người theo dõi</div>
                </div>
                <div style="text-align:center;">
                    <div style="font-size:2rem; font-weight:900; color:#7B8B6F;">10+</div>
                    <div style="font-size:0.85rem; color:#5A524C; font-weight:700;">Năm gieo mầm sáng tạo</div>
                </div>
                <div style="text-align:center;">
                    <div style="font-size:2rem; font-weight:900; color:#C9A84C;">1,000+</div>
                    <div style="font-size:0.85rem; color:#5A524C; font-weight:700;">Học viên đã tham gia</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="about" style="padding:5rem 1.5rem; background:#FFFCF7;">
        <div style="max-width:1000px; margin:0 auto;">
            <div style="text-align:center; margin-bottom:3rem;">
                <p style="font-size:0.9rem; font-weight:800; color:#D4896E; text-transform:uppercase; letter-spacing:0.08em; margin-bottom:0.5rem;">Câu chuyện của chúng mình</p>
                <h2 style="font-size:clamp(1.6rem,3.5vw,2.4rem); font-weight:900; color:#2D2926;">
                    Từ tro tàn tuổi 30, một giấc mơ hồi sinh
                </h2>
            </div>

            {{-- Founder: image + story side by side --}}
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:2.5rem; align-items:center; margin-bottom:2.5rem;" class="founder-grid">
                <div style="text-align:center;">
                    <img src="/images/landing/founder-fullbody.jpg" alt="Cúc Cu — Tranh & Đời thật"
                         style="max-width:100%; border-radius:0.75rem; box-shadow:0 4px 20px rgba(0,0,0,0.08);">
                    <img src="/images/landing/founder-cuccu.jpg" alt="Cúc Cu chibi"
                         style="max-width:100%; border-radius:0.75rem; box-shadow:0 4px 20px rgba(0,0,0,0.08); margin-top:1rem;">
                </div>
                <div>
                    <div class="card" style="padding:1.75rem; border-left:3px solid #D4896E; margin-bottom:1.25rem;">
                        <p style="font-size:1.05rem; line-height:1.85; color:#2D2926; font-weight:500;">
                        ...
                        <p style="font-size:1.05rem; line-height:1.85; color:#2D2926; margin-top:0.75rem; font-weight:500;">
                    ...
                    <div class="card" style="padding:1.75rem; border-left:3px solid #7B8B6F;">
                        <p style="font-size:1.05rem; line-height:1.85; color:#2D2926; font-weight:500;">
                            Thời bé, tôi có một ước mơ cháy bỏng: tạo ra một thế giới nơi tuổi thơ và trí sáng tạo được sống mãi mãi — như Neverland của Peter Pan.
                        </p>
                        <p style="font-size:1.05rem; line-height:1.85; color:#2D2926; margin-top:0.75rem; font-weight:500;">
                            Và rồi tôi quyết định tạo ra <strong style="color:#7B8B6F;">Cuc Cu's Dream Factory</strong>.
                            Khi cho phép bản thân được chân thật và yếu đuối, điều kỳ diệu đã xảy ra: tôi nhận được sự vỗ về từ những người xa lạ.
                        </p>
                    </div>
                </div>
            </div>
            ...
            {{-- Mission statement --}}
            <div style="background:linear-gradient(135deg, #F5E0D5, #E5EBE0); border-radius:0.75rem; padding:2.5rem; text-align:center;">
                <p style="font-size:1.3rem; font-weight:800; line-height:1.7; color:#2D2926;">
                    "Giúp người khác làm bạn với chính mình<br>
                    & nhớ lại mơ ước ban sơ qua hình vẽ."
                </p>
                <p style="font-size:0.95rem; color:#5A524C; margin-top:0.75rem; font-weight:700;">— Cúc Cu Nguyễn, Founder</p>
            </div>
        </div>
    </section>
    ...
    <section style="padding:5rem 1.5rem; background:#F5EDE0;">
        <div style="max-width:1000px; margin:0 auto;">
            <div style="text-align:center; margin-bottom:3rem;">
                ...
                <p style="font-size:1.05rem; color:#6B6158; margin-top:0.75rem; max-width:600px; margin-left:auto; margin-right:auto;">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:1.5rem;">
                ...
                <div class="card" style="padding:1.75rem; text-align:center;">
                    ...
                    <p style="font-size:0.95rem; color:#6B6158; line-height:1.7;">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:1.5rem;">
                ...
                <div class="card" style="padding:0; overflow:hidden;">
                    ...
                    <div style="padding:1.25rem;">
                        <p style="font-size:0.9rem; color:#6B6158; line-height:1.7; margin-bottom:1rem;">
    ...
    <section id="community" style="padding:5rem 1.5rem; background:#F5EDE0;">
        <div style="max-width:1000px; margin:0 auto;">
            <div style="text-align:center; margin-bottom:3rem;">
                ...
                <p style="font-size:1.05rem; color:#6B6158; margin-top:0.75rem;">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(300px, 1fr)); gap:1.5rem;">
                ...
                <div class="card" style="padding:1.75rem;">
                    ...
                    <p style="font-size:0.95rem; color:#2D2926; line-height:1.8; font-style:italic;">
                    ...
                    <div style="margin-top:1rem; display:flex; align-items:center; gap:0.75rem;">
                        ...
                        <div>
                            ...
                            <div style="font-size:0.75rem; color:#6B6158;">Học viên Dare To Draw</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="padding:1.75rem;">
                    ...
                    <div style="margin-top:1rem; display:flex; align-items:center; gap:0.75rem;">
                        ...
                        <div>
                            ...
                            <div style="font-size:0.75rem; color:#6B6158;">Tác giả cuộc thi vẽ</div>
                        </div>
                    </div>
                </div>
            ...
            <div style="margin-top:2.5rem; margin-bottom:2rem;">
                <p style="text-align:center; font-size:0.85rem; font-weight:700; color:#6B6158; text-transform:uppercase; letter-spacing:0.06em; margin-bottom:1rem;">Tác phẩm học viên</p>
            ...
            <div style="margin-top:2.5rem; background:linear-gradient(135deg, #F5E0D5, #E5EBE0); border-radius:0.75rem; padding:2rem; text-align:center;">
                <p style="font-size:1.05rem; color:#2D2926; line-height:1.8; max-width:650px; margin:0 auto;">
        ...
        <div style="max-width:900px; margin:0 auto;">
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:1.5rem;">
                <div class="card" style="padding:1.75rem; text-align:center;">
                    ...
                    <p style="font-size:0.9rem; color:#6B6158; line-height:1.7;">
    ...
    <section id="press" style="padding:5rem 1.5rem; background:#F5EDE0;">
        <div style="max-width:900px; margin:0 auto; text-align:center;">
            <p style="font-size:0.85rem; font-weight:700; color:#6B6158; text-transform:uppercase; letter-spacing:0.08em; margin-bottom:0.5rem;">Báo chí & Truyền hình</p>
            ...
            <p style="font-size:0.95rem; color:#6B6158; margin-top:2rem; line-height:1.7; max-width:600px; margin-left:auto; margin-right:auto;">
    ...
    <section style="padding:4rem 1.5rem; background:#FFFCF7;">
        <div style="max-width:700px; margin:0 auto; text-align:center;">
            ...
            <p style="font-size:1.05rem; color:#6B6158; line-height:1.8; max-width:550px; margin:0 auto;">
    ...
    <section style="padding:5rem 1.5rem; background:linear-gradient(135deg, #F5E0D5, #E5EBE0);">
        <div style="max-width:700px; margin:0 auto; text-align:center;">
            ...
            <p style="font-size:1.1rem; color:#2D2926; line-height:1.8; margin-bottom:2rem;">
    ...
    <footer style="padding:2.5rem 1.5rem; background:#2D2926; color:#E0D5C5;">
        <div style="max-width:1000px; margin:0 auto; display:flex; flex-wrap:wrap; justify-content:space-between; align-items:center; gap:1.5rem;">
            <div>
                <span style="font-size:1.2rem; font-weight:800;">
                    <span style="color:#D4896E;">Cúc Cu</span> <span style="color:#7B8B6F;">Dream</span><span style="font-size:0.65rem; color:#6B6158;">™</span>
                </span>
                <p style="font-size:0.8rem; color:#6B6158; margin-top:0.25rem;">Đánh thức giấc mơ nguyên thuỷ qua nghệ thuật</p>
            </div>
        ...
        <div style="max-width:1000px; margin:1.5rem auto 0; border-top:1px solid rgba(255,255,255,0.1); padding-top:1rem;">
            <p style="font-size:0.75rem; color:#6B6158; text-align:center;">
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .founder-grid > div:first-child { display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; }
        }
    </style>
</div>
